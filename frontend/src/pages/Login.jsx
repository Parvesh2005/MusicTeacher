...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-teal-blue via-teal-blue/10 to-soft-off-white flex items-center justify-center p-6">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 space-y-6">
                <div className="text-center">
                    <h2 className="text-3xl font-bold text-teal-blue mb-2">Welcome Back!</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button type="submit" className="w-full bg-teal-blue text-white font-bold py-3 px-4 rounded-lg hover:bg-vibrant-purple transition-transform transform hover:scale-105 duration-300">
                        Log In
                    </button>
                </form>
                 <p className="text-center text-sm text-gray-600">
                    Don't have an account?{' '}
                    <Link to="/register-student" className="text-teal-blue hover:underline font-bold">Sign up here</Link>.
                </p>
            </div>
        </div>
    );
